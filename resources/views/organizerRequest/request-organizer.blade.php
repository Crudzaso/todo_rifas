                ...
                <tr>
                    ...
                    <td>
                        @if($request->status == 'pending')
                            <form action="{{ route('admin.organizerRequests.approve', $request->id) }}" method="POST" style="display:inline;">
                                @csrf
                                <button type="submit" class="btn btn-success">Aprobar</button>
                            </form>
                            <form action="{{ route('admin.organizerRequests.reject', $request->id) }}" method="POST" style="display:inline;">
                                @csrf
