<!--begin::Landing hero-->
<div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9" style="height: 50vh; padding: 0 9px;">
    <!--begin::Heading-->
    <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
        <!--begin::Title-->
        <h1 class="text-white lh-base fw-bold fs-2x fs-lg-3x mb-15">TODO RIFAS
            <img src="{{asset('assets/media/images/todo_rifas_pet.png')}}" style="width: 150px; height: auto;" alt="Logo">
            <span style="background: linear-gradient(to right, #12CE5D 0%, #FFD80C 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
								<span id="kt_landing_hero_text">¡La suerte en tus manos!
                                </span>
							</span></h1>
        <!--end::Title-->
    </div>
